...
| [`03-restore-man-doc-and-info.sh`](03-restore-man-doc-and-info.sh) | bringing back man pages, info pages and documentation |
| [`04-add-a-locale.sh`](04-add-a-locale.sh) | adding a non-English locale, and why the obvious two lines fail quietly |
